const Contact = () => {
  return (
    <div className=" text-gray-100 px-8 ">
      ...
      <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg ">
        ...
        <div className="">
          <div>
            ...
            <input
              className="w-full bg-violet-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text"
              placeholder=""
            />
          </div>
          ...
          <div className="mt-8">
            ...
            <textarea className="w-full h-32 bg-violet-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          </div>
          <div className="mt-8">
